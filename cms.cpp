...
public:
    ...
    void getSales()
    {
        ...
        else
        {
            ...
            while (rf)
            {
                ...
                if (ix == 0)
                {
                    for (int i = 1; i <= (27 - line.length()); i++)
                        cout << " ";
                }
                else if (ix == 1)
                {
    ...
    li *editMenu(li *head)
    {
        ...
        do
        {
            ...
            {
            case 1:
                head = ems.addnewItem1(head);
                break;
            case 2:
                head = ems.addnewItem2(head);
                break;
            case 3:
                head = ems.addnewItem3(head);
                break;
            case 4:
                head = ems.removeItem(head);
                break;
            case 5:
                head = ems.replaceItem(head);
                break;
            }
        } while (ops > 5 || ops < 1);
